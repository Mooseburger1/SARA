...
type AlbumsInfo struct {
	...
	FailedRequest []byte       `protobuf:"bytes,3,opt,name=failed_request,json=failedRequest,proto3" json:"failed_request,omitempty"`
}
...
func (x *AlbumsInfo) GetFailedRequest() []byte {
	if x != nil {
...
func (x *PhotosInfo) GetFailedRequest() []byte {
	if x != nil {
		return x.FailedRequest
	}
	return nil
...
var file_photos_proto_rawDesc = []byte{
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0d, 0x66, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x52, 0x65,
	...
	0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0d, 0x66, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x52,
